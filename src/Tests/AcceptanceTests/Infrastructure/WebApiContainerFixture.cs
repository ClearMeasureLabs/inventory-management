...
public class WebApiContainerFixture : IAsyncDisposable
{
    ...
    public async Task StartAsync()
    {
        ...
        _container = new ContainerBuilder()
            ...
            .WithEnvironment("SqlServer__Host", _testEnvironment.SqlContainerIp)
            ...
            .WithEnvironment("Redis__Host", _testEnvironment.RedisContainerIp)
            .WithEnvironment("Redis__Port", "6379")
            .WithEnvironment("Redis__User", "default")
            .WithEnvironment("RabbitMQ__Host", _testEnvironment.RabbitMqContainerIp)
